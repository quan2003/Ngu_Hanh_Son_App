        ...
        title: Row(
          children: [
            Container(
              ...
              child:
                  const Icon(Icons.privacy_tip_outline, color: AppColors.info),
            ),
            const SizedBox(width: 12),
        ...
        title: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.article_outline, color: AppColors.info),
            ),
            const SizedBox(width: 12),
        ...
        title: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.policy_outline, color: AppColors.info),
            ),
            const SizedBox(width: 12),
